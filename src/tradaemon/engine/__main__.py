"""Entry point: python -m tradaemon.engine"""
...
from tradaemon.engine.loop import RestartRequested, TradingEngine
...
log = logging.getLogger("tradaemon")
...
def main() -> None:
    ...
    if cfg.mode == "live":
        from tradaemon.data.ingestion import make_exchange
        from tradaemon.execution.executors import LiveExecutor
