...
2. One cost model. Backtests go through tradaemon.backtest.runner, which shares
   tradaemon.execution.fills with the paper/live executor.
...
from tradaemon.features.engineering import FEATURE_COLUMNS, compute_atr, compute_features
from tradaemon.labeling.triple_barrier import triple_barrier_labels
from tradaemon.models.train import ModelBundle, make_classifier
