...
from tradaemon.backtest.metrics import periods_per_year, summarize
from tradaemon.config import Config
from tradaemon.execution.fills import buy_fill, check_bracket_exit, sell_fill
from tradaemon.features.engineering import compute_atr
...
def barrier_labels(
    ...
    Same conventions as tradaemon.labeling.triple_barrier: scan t+1..t+H, label 1
