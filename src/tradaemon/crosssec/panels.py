...
from tradaemon.portfolio.data import download_etf
from tradaemon.portfolio.data import load_panel as load_yahoo_panel
...
def download_crypto_daily(data_dir: Path, symbol: str, days: int = 2000) -> pd.DataFrame:
    ...
    from tradaemon.data.ingestion import fetch_ohlcv_range
