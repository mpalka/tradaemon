...
`src/tradaemon/__init__.py` (0.2.0 → 0.2.1) and adds a line to **both** changelogs —
...
- **User-facing strings live in `src/tradaemon/locales/pl.py` and `en.py`**, never inline
